...
namespace MegaMatrrixTest
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMinusOperation()
        {
            ...
            Matrix resultMatrix = (inputMatrix - inputMatrix);
            int getnumber = resultMatrix.InnerMatrix[0, 0];
            Assert.AreEqual(getnumber, check);
        }
        [TestMethod]
        ...
        public void TestDeterminantOperation()
        {
            ...
            Assert.AreEqual(determinant, check);
        }
        [TestMethod]
        ...
        [TestMethod]
        public void TestOfGreaterThanFirstMatrixGreater()
        {
        ...
        [TestMethod]
        public void TestOfLessThanFirstMatrixLess()
        {
